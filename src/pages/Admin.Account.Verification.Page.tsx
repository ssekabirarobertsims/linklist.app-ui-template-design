...
const AdminAccountVerificationPageElementsComponent: React.FunctionComponent =
  () => {
    const PrimaryAuthenticationObject = useContext(
    ...
    const handleVerification = async () => {
      ...
      try {
        ...
        const { data: response } = await axios.post(
          "https://api-linklist-restapi.onrender.com/admin/account/verification",
          {
      ...
      <>
        ...
        <section className="admin-account-verification-page-elements-component">
          ...
          >
            ...
            <span className="verification-response-message-placeholder">
              {responseMessage}
            </span>
            <div>
          ...
          <p>
            ...
            <strong>
              {PrimaryAuthenticationObject?.email || "your email"}
            </strong>
            . Fill in the form with the sent verification code to enable us to
