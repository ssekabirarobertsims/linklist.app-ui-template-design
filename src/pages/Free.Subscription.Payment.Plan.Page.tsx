        ...
        <section className="free-admin-account-subscription-payment-plan-page-elements-component">
          ...
          >
            <div id="_wrapper">
              ...
              <h1>Subscribe to LinkList for a free plan</h1>
              ...
              <br />
              {/* 
                            If the admin is already subscribed, show the "Upgrade plan" button 
                            that navigates to the subscription plans page.
                            Otherwise, show the "subscribe" button to trigger the free plan subscription.
                        */}
          ...
          <p>
            ...
            free payment plan as{" "}
            {currentAdmin?.data?.username || "Admin Username Undefined"}, you
            will receive an email at{" "}
            <strong>
              {currentAdmin?.data?.email || "Admin Email Undefined"}
            </strong>{" "}
            to confirm your subscription to the monthly newsletter and be able
            to get access to minimum storage of links that are not more than 50
            links stored in your admin account links list per year without any
            subscription plan or fee.
          </p>
        </section>
      </>
    );
