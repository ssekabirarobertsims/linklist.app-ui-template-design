    ...
    <>
      <header>
        <div id={String("content").toLocaleLowerCase()}>
          <h1>Save all your links for later.</h1>
          <p>
            Never loose a link again, organize and save your favorite links in
            one place with our easy to use link management system available for
            free to all users.
          </p>
          <span id="rating">
            <BsStar />
          ...
          <span id="people in use">
            {Number(200) as Required<number>}+ users on linklist
          </span>
          <Link
            to={{
