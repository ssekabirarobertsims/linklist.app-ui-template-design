...
const SubscriptionPaymentPlansPageContentComponent: React.FunctionComponent =
  () => {
    ...
    // Retrieve the primary authentication object from localStorage
    // This is used to personalize the subscription plan links for the current user
              ...
              <aside className="subscription-payments-component">
                ...
                <div className="subscription-payment-plan" id="free">
                  <article>
                    ...
                    <span>$0/year</span>
                    {/* Button navigates to the free plan subscription page for the current user */}
                    <Link
                      to={{
                        pathname: `/${String(
